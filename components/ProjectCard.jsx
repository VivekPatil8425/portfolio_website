...
const ProjectCard = ({ project }) => {
  ...
  return (
    <Tilt
      ...
      className="h-fit"
    >
      <div className='bg-[#18181b] rounded-2xl'>
        ...
        <div className='p-4'>
          ...
          <div className='flex-between mt-3 gap-1'>
            <div className='flex gap-2'>
              {
                project?.tech?.map((t, i) => {
                  return <div key={i} className='p-2 bg-zinc-800 rounded-md w-fit'>
            ...
            <a
              href={project.github}
              target="_blank"
              className="p-2  text-sm bg-zinc-800 hover:bg-zinc-950   rounded-md"
            >
              Github
            </a>
