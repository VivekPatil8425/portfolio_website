        ...
        <div className="flex flex-col lg:gap-10 lg:flex-row max-w-6xl mx-auto py-14 mt-14 px-6 lg:px-8">
            ...
            <div className="mt-8 lg:mt-0 lg:w-[45%] ">
                <form ref={form} onSubmit={sendEmail} className="flex w-full flex-col lg:px-7 gap-y-5 ">
                    <input type="text" name="user_name" required placeholder="Your name" className="w-full bg-zinc-900 rounded-lg p-4  outline-none" />
                    <input type="email" name="user_email" required placeholder="Your Email Address" className="w-full  bg-zinc-900 rounded-lg p-4 outline-none" />
                    <textarea required name="message" placeholder="Write your message ..." className="w-full  bg-zinc-900 h-32 rounded-lg  p-4 outline-none" />
                    <div>
                        <button type="submit" className="p-4 bg-zinc-900 hover:bg-zinc-950 rounded-lg" >Send message</button>
                    </div>
                </form>
            </div>
        </div>
